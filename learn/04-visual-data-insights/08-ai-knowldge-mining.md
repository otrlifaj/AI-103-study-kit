...
**Module:** `ai-knowldge-mining` | **Source:** Microsoft Learn AI-103  
**Slug:** `learn.wwl.ai-knowledge-mining`
...
> **Note:** Different people learn in different ways. The original module offers both video-based and text/image formats; this KB captures the full text content.
...
![Diagram of Azure AI Search supporting multiple applications.](resources/ai-knowldge-mining-ai-search.png)
...
![Diagram of an indexer extracting documents from a source and creating an index.](resources/ai-knowldge-mining-indexer.png)
...
![Diagram of an indexer using a skillset to enrich data.](resources/ai-knowldge-mining-skillset.png)
...
> **Tip:** To learn more about using custom skills with Azure AI Search, see [Add a custom skill to an Azure AI Search enrichment pipeline](https://learn.microsoft.com/en-us/azure/search/cognitive-search-custom-skill-interface) in the Azure AI Search documentation.
...
![Diagram of a client searching an Azure AI Search index.](resources/ai-knowldge-mining-search-index.png)
...
![Diagram of an indexing process loading projections into a knowledge store.](resources/ai-knowldge-mining-knowledge-store.png)
...
Hands-on lab: [04-knowledge-mining.md](../../../labs/mslearn-ai-information-extraction/Instructions/Exercises/04-knowledge-mining.md)
