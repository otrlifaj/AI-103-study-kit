...
**Module:** `prepare-azure-ai-development`  
...
| Tool | Description |
| --- | --- |
| ![Azure Language icon.](resources/prepare-azure-ai-development-azure-language.png)**Azure Language** | Azure Language in Foundry Tools provides models and APIs that you can use to analyze natural language text and perform tasks such as entity extraction, sentiment analysis, and summarization. Azure Language also provides functionality to help you build conversational language models and question answering solutions. |
| ![Azure Speech icon.](resources/prepare-azure-ai-development-azure-speech.png)**Azure Speech** | Azure Speech in Foundry Tools provides APIs that you can use to implement *text to speech* and *speech to text* transformation, as well as real-time live speech for conversational apps and agents. |
| ![Azure Translator icon.](resources/prepare-azure-ai-development-azure-translator.png)**Azure Translator** | Azure Translator in Foundry Tools uses state-of-the-art language models to translate text between a large number of languages. |
| ![Azure Document Intelligence icon.](resources/prepare-azure-ai-development-azure-document-intelligence.png)**Azure Document Intelligence** | With Azure Document Intelligence in Foundry Tools, you can use pre-built or custom models to extract fields from complex documents such as invoices, receipts, and forms. |
| ![Azure Content Understanding icon.](resources/prepare-azure-ai-development-azure-content-understanding.png)**Azure Content Understanding** | Azure Content Understanding in Foundry Tools provides multi-modal content analysis capabilities that enable you to build models to extract data from forms and documents, images, videos, and audio streams. |
...
![Diagram of a Foundry project.](resources/prepare-azure-ai-development-foundry.png)
...
![Screenshot of the Foundry portal.](resources/prepare-azure-ai-development-foundry-portal.png)
...
![Screenshot of the Foundry Toolkit extension for Visual Studio Code.](resources/prepare-azure-ai-development-vs-code.png)
...
![Screenshot of GitHub Copilot in Visual Studio Code.](resources/prepare-azure-ai-development-github-copilot.png)
...
![A diagram of scales.](resources/prepare-azure-ai-development-fairness.png)
...
![A diagram of a shield.](resources/prepare-azure-ai-development-reliability-safety.png)
...
![A diagram of a padlock.](resources/prepare-azure-ai-development-privacy-security.png)
...
![A diagram of a diverse group of people.](resources/prepare-azure-ai-development-inclusiveness.png)
...
![A diagram of an eye.](resources/prepare-azure-ai-development-transparency.png)
...
![A diagram of a handshake.](resources/prepare-azure-ai-development-accountability.png)
...
For the latest news and information about developing AI applications on Azure, see **[Azure AI](https://azure.microsoft.com/solutions/ai)**.

---

## Exercise / Lab

Hands-on lab: [01-Explore-ai-studio.html](../../../labs/mslearn-ai-studio/Instructions/Exercises/01-Explore-ai-studio.md)
